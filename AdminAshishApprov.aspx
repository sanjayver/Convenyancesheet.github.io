<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAshishApprov.aspx.cs" Inherits="Institute1.AdminAshishApprov" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:GridView ID="GridView1" runat="server" CssClass="table" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                <Columns>
                    ...
                    <asp:BoundField DataField="typeofapproval" HeaderText="Type Of Payment Mode">
                    <ItemStyle HorizontalAlign="Center" />
                    </asp:BoundField>
            ...
            <br />
            <asp:Button ID="Button2" runat="server" BackColor="#66FFFF" BorderColor="#66FFFF" BorderStyle="Solid" Font-Bold="True" ForeColor="#000066" Height="42px" OnClick="Button2_Click" Text="Submit For Approval" Width="169px" />
            <br />
            <br />
            <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#000066"></asp:Label>
            <br />
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myschool %>" SelectCommand="select empid,typeofapproval,employeename,date,noofdays,amount,teamleader from ashishapprove where (admin='None Approved')"></asp:SqlDataSource>
        </div>
    </form>
</body>
</html>
