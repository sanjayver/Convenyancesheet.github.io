<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminAshishleavelist.aspx.cs" Inherits="Institute1.AdminAshishleavelist" %>
...
<body>
   <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Button ID="Button1" runat="server" BackColor="#0099FF" BorderColor="#66FFFF" BorderStyle="Solid" Font-Bold="True" Font-Size="Large" ForeColor="White" PostBackUrl="~/AdminEmpApplyLea.aspx" Text="Cancel" Width="113px" />
            </span>
            ...
            <center><table>
                ...
                <tr>
                    <td colspan="3">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myschool %>" SelectCommand="SELECT DISTINCT * FROM [ashishapprove]"></asp:SqlDataSource>
