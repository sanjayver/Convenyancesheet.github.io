<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminMahendraApprov.aspx.cs" Inherits="Institute1.AdminMahendraApprov" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myschool %>" SelectCommand="select empid,typeofapprove,employeename,date,noofdays,amount,teamleader from mahendraapprove where (admin='None Approved')"></asp:SqlDataSource>
            <br />
            <br />
