<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminMahendraleavelist.aspx.cs" Inherits="Institute1.AdminMahendraleavelist" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Button ID="Button1" runat="server" BackColor="#0099FF" BorderColor="#66FFFF" BorderStyle="Solid" Font-Bold="True" Font-Size="Large" ForeColor="White" Text="Cancel" Width="113px" PostBackUrl="~/AdminEmpApplyLea.aspx" />
            </span>
        </div>
        <div class="container">
           ...
           <center> <table class="auto-style2">
                ...
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" CssClass="table" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="empid" DataSourceID="SqlDataSource1">
                            <Columns>
