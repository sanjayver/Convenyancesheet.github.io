<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminMahendratravelR.aspx.cs" Inherits="Institute1.AdminMahendratravelR" EnableEventValidation="false"%>
...
<body>
  ...
  <!-- Links -->
            ...
            <br />
            <div class="container">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="empid" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound" ShowFooter="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                    <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myschool %>" SelectCommand="SELECT DISTINCT * FROM [Mahendratravelregister]"></asp:SqlDataSource>
            </div><br />
            <asp:Button ID="Button2" runat="server" Text="Export To Excel " BackColor="#66CCFF" BorderColor="#66FFFF" BorderStyle="Solid" Font-Bold="True" Font-Size="Large" ForeColor="#000066" Width="156px" OnClick="Button2_Click" />
        <br /><br />
        </div>
    </form>
</body>
