<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminRakeshApproveReject.aspx.cs" Inherits="Institute1.AdminRakeshApproveReject" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myschool %>" SelectCommand="SELECT DISTINCT * FROM [Rakeshapplyleave]" DeleteCommand="delete from Rakeshapplyleave where empid=@empid">
