<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminRakeshLeavelist.aspx.cs" Inherits="Institute1.AdminRakeshLeavelist" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
           ...
           <center> <table class="auto-style2">
                ...
                <tr>
                    <td colspan="3">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" CssClass="table" DataKeyNames="empid" DataSourceID="SqlDataSource1">
                            <Columns>
