<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RakeshApplyleave.aspx.cs" Inherits="Institute1.RakeshApplyleave" %>
...
<body>
     <form id="form1" runat="server">
        <div class="auto-style7">
            ...
            <div class="text-left">
                <span class="auto-style41"><strong>
                <br />
                Apply For Payment Leave :</strong></span><br />
                <br />
            <a href="rakeshhome.aspx" style="text-decoration:none;" class="auto-style41"><span class="auto-style40"><strong>Cancel</strong></span></a>
            <br />
            <br />
            ...
            <table align="center" class="auto-style1">
                ...
                <tr>
                    ...
                    <td class="auto-style29">
                        ...
                        <asp:ImageButton ID="ImageButton1" runat="server" Height="21px" ImageUrl="~/image/istockphoto-181866332-612x612.jpg" Width="32px" ImageAlign="AbsBottom" OnClick="ImageButton1_Click" />
                ...
                <tr>
                    <td class="auto-style25"><strong>Team Leader</strong></td>
                    <td class="auto-style32">
                ...
                <tr>
                    ...
                    <td class="auto-style31">
                        ...
                        <asp:Button ID="Button2" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#000066" OnClick="Button2_Click" Text="Apply" Width="124px" />
