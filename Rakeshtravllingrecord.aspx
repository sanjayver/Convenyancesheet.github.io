<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Rakeshtravllingrecord.aspx.cs" Inherits="Institute1.Rakeshtravllingrecord" EnableEventValidation="false"%>
   ...
   <form id="form1" runat="server">
            ...
            <div class="container">
                ...
                <div class="text-left">
                    ...
                    <br />
                    User Register Travalling Record : </strong></span>
                    <br />
                    <br />
                    <strong><span class="auto-style27">
                <a href="rakeshhome.aspx" style="text-decoration:none;" class="auto-style28">Cancel</a></span></strong>
                </div>
                        ...
                        <table class="auto-style10">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:ImageButton ID="ImageButton1" runat="server" Height="24px" ImageUrl="~/image/istockphoto-181866332-612x612.jpg" Width="33px" ImageAlign="AbsBottom" OnClick="ImageButton1_Click" />
                            ...
                            <tr>
                                ...
                                <td class="auto-style20">
                                    ...
                                    <asp:Button ID="Button1" runat="server" Font-Bold="True" ForeColor="#000066" Height="37px" Text="Add Record" Width="106px" OnClick="Button1_Click" />
                                    
                                </td>
                                <td class="auto-style21">
                                    
            <asp:Button ID="Button2" runat="server" Text="Submit " Font-Bold="True" Font-Size="Large" ForeColor="#000099" OnClick="Button2_Click" Height="37px" Width="104px" />
       ...
       <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#000066"></asp:Label>
            ...
            <center><asp:GridView ID="GridView1" runat="server" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
