<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMashishapproved.aspx.cs" Inherits="Institute1.TMashishapproved" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myschool %>" SelectCommand="select empid,typeofapproval,employeename,Date,noofdays,amount,Admin from ashishapprove where (teamleader='None Approved')"></asp:SqlDataSource>
            <br />
        </div>
    </form>
</body>
