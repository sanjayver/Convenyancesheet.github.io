<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMashishleavelist.aspx.cs" Inherits="Institute1.TMashishleavelist" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Button ID="Button1" runat="server" BackColor="#0099FF" BorderColor="#66FFFF" BorderStyle="Solid" Font-Bold="True" Font-Size="Large" ForeColor="White" PostBackUrl="~/TMEmpApplyLeave.aspx" Text="Cancel" Width="113px" />
            </span>
