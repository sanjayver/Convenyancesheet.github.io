<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMmahenderleavelist.aspx.cs" Inherits="Institute1.TMmahenderleavelist" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <asp:Button ID="Button1" runat="server" BackColor="#0099FF" BorderColor="#66FFFF" BorderStyle="Solid" Font-Bold="True" Font-Size="Large" ForeColor="White" Text="Cancel" Width="113px" PostBackUrl="~/TMEmpApplyLeave.aspx" />
            </span>
        </div>
        <div class="container">
