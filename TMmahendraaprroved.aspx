<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMmahendraaprroved.aspx.cs" Inherits="Institute1.TMmahendraaprroved" %>
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:myschool %>" SelectCommand="select empid,typeofapprove,employeename,date,noofdays,amount,admin from mahendraapprove where (teamleader='None Approved')"></asp:SqlDataSource>
            <br />
        </div>
    </form>
</body>
