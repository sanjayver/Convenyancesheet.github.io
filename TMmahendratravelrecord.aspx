<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TMmahendratravelrecord.aspx.cs" Inherits="Institute1.TMmahendratravelrecord" EnableEventValidation="false"%>
...
<body>
  ...
  <!-- Links -->
            ...
            <br />
            <div class="container">
                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="empid" DataSourceID="SqlDataSource1" OnRowDataBound="GridView1_RowDataBound" ShowFooter="True" CssClass="table">
                    <Columns>
