<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TmRegister.aspx.cs" Inherits="Institute1.TmRegister" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="container">
            ...
            Admin Register&nbsp; :<br />
            <br />
            <a href="TeamLeaderHomePage.aspx" style="text-decoration:none; color:darkblue;">Cancel</a>
            <br />
            </span></strong>
            <br />
            <table class="auto-style2" align="center">
                ...
                <tr>
                    ...
                    <td class="auto-style28">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtlname" Display="Dynamic" ErrorMessage="* Required Field Validator" Font-Size="Medium" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">
                    ...
                    <td class="auto-style6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="DropDownList2" Display="Dynamic" ErrorMessage="* Required Field Validator" Font-Size="Medium" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">
                    ...
                    <td class="auto-style6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtmobileno" Display="Dynamic" ErrorMessage="* Required Field Validator" Font-Size="Medium" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style26">
                ...
                <tr>
                    ...
                    <td class="auto-style6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="DropDownList1" Display="Dynamic" ErrorMessage="* Required Field Validator" Font-Size="Medium" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="auto-style4">
                    ...
                    <td class="auto-style6">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtqualification" Display="Dynamic" ErrorMessage="* Required Field Validator" Font-Size="Medium" ForeColor="Red" SetFocusOnError="True"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="auto-style36">
                        ...
                        <asp:Button ID="Button2" runat="server" Font-Bold="True" Font-Size="Large" ForeColor="#000066" Height="39px" OnClick="Button2_Click" Text="Register" Width="116px" />
